...
manifest:org.opencontainers.image.description="KSGate is a Kubernetes controller that manages the scheduling of pods using declarative gates and conditions.",\
...
helm: ## Package helm chart
	helm package --app-version $(IMG_VERSION) ./helm -d dist
