...
This is where KSGate comes in. It automates the process of evaluating conditions and removing gates.

## Documentation

### Gates
Gates must be prefixed with `k8s.ksgate.org/` to be recognized by KSGate. The suffix is used to identify individual gates and is arbitrary.
